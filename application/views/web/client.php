<header id="semanas-header" class="container pt-70">
	...
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1">
			<p class = 'pt-20 curso-desc'>En esta sección estará todo el material disponible de la materia por unidad. Podrás encontrar diapositivas, videos, talleres, libros y más masterial para complementar lo aprendido en clases.</p>
		</div>
	</div>
</header>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-5 col-xs-10">
										<a href="<?php echo base_url('public/material fundamentos/Semana a Semana/Semana 1/01 - Introduccion.pptx'); ?>" download> Diapositivas: Introducción </a>
									</div>
								</div>
								<hr>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-5 col-xs-10">
										<a href="<?php echo base_url('public/material fundamentos/Semana a Semana/Semana 1/texto.pdf'); ?>" download> Libro: Programación en Python - Luis Rodríguez </a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingTwo">
						...
						<h4 class="panel-title">
							<a 	 role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">2. Variables y Tipos de Datos
							</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">3. Estructuras de Control</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingFour">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">4. Listas</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingFive">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">5. Arreglos N-Dimensionales</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingSix">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">6. Funciones</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingSeven">
								...
								<h4 class="panel-title"><a  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">7. Colecciones</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingEight">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseEight" aria-expanded="false" aria-controls="collapseEight">8. Archivos: Entrada/Salida</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingNine">
								...
								<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseNine" aria-expanded="false" aria-controls="collapseNine">9. Procesamiento de Datos</a></h4>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingTen">
								...
								<h4 class="panel-title"><a  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTen" aria-expanded="false" aria-controls="collapseTen">10. Examenes Anteriores</a></h4>
